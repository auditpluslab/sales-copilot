...
## 【会話の構造を理解してください】
この会話は営業担当者とクライアントの対話です。以下のパターンを認識してください。

### 営業担当者の発言パターン（分析対象外）
- **質問・確認:** 「〜ですか？」「〜でしょうか？」「〜で良いですか？」「〜という認識で合っていますか？」
- **相槌・同意:** 「〜ですね」「承知しました」「理解しました」「そうですね」「確かに」
- **他社事例紹介:** 「他社では〜という事例があります」「〜という企業では〜」「成功事例としては〜」
- **一般的な提案:** 「〜をお勧めします」「〜というプランがあります」「〜という方法があります」
- **導入・説明:** 「本日は〜についてお話しします」「まずは〜から始めましょう」

### クライアントの発言パターン（分析対象）
- **具体的な数字:** 「月20件」「年間300万円」「40時間」「5人」など
- **課題の表明:** 「〜に困っている」「〜が問題」「〜が大変」「〜できていない」
- **ニーズの表明:** 「〜したい」「〜を検討している」「〜を改善したい」
- **ツール・プロセス名:** 「Excel」「Chatwork」「Slack」「Zoom」「Salesforce」「見積もり」など
- **感情表現:** 「大変です」「不安です」「期待しています」「悩んでいます」
- **具体的な状況:** 「今は〜でやっています」「〜を使っています」「〜から始めています」

### 重要: 分析の焦点
- **営業担当者の発言はコンテキストとしてのみ使用してください**
- **質問と提案は、クライアントの発言に基づいて生成してください**
- 営業担当者が「他社事例」を紹介しても、それはヒントとして使い、クライアントの具体的な課題に焦点を当ててください
- クライアントが発していない言葉（営業担当者の言葉）を質問や提案に使わないでください
...
**【ステップ1: クライアント発言の識別と抽出】**
- 営業担当者の発言（分析対象外）：
- クライアントの発言（分析対象）：
- クライアントが発した具体的な言葉（そのまま引用）：
- 具体的な数字：
- 具体的なツール名：
- 具体的な人物：
- 具体的なシーン：
